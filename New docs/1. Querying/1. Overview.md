...
Types that represent table rows are dynamically generated and any changes you make to your workbook tables (e.g. adding a new column) are immediately reflected in your C# scripts.
