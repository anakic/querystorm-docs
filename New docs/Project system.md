...
- **Component files** are ordinary class files which are generated from a template that provides a skeleton component class which the user can users can use as a starting point for creating their own components
