...
QueryStorm objects expose a set of APIs that your scripts can interact with. The members and APIs that are available to user scripts are described below.
...
```csharp
people.SelectedRows.FirstOrDefault()?.Id
```
